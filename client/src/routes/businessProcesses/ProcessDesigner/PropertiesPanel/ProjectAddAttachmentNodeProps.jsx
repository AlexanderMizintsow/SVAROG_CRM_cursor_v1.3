...
const ProjectAddAttachmentNodeProps = ({ node, onUpdate }) => {
  ...
  return (
    <div className="properties-panel__fields">
      ...
      <p className="properties-panel__hint">
        Блок добавляет вложение в проект по <b>готовой ссылке</b>. Загрузку файла (получение URL) выполняйте вашей текущей
        логикой CRM, а сюда передавайте уже известный <code>file_url</code>.
      </p>
...
export default ProjectAddAttachmentNodeProps
