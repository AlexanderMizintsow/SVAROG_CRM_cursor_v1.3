  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        purpose:
          'Для каждого узла (этапа) процесса показывается: сколько раз этап проходили, время работы на этапе, задачи и проекты, связанные с этапом, ожидание ответов по почте. По этим данным определяется «узкое место» — этап с максимальным суммарным временем.',
        steps: [
          'Этап — название узла в схеме БП.',
          'Проходов — сколько раз экземпляры процесса проходили этот этап за период.',
          'Ср./макс/всего время этапа — среднее, максимальное и суммарное время на этапе.',
          'Задачи, С дедл., Просрочено — количество задач, связанных с этапом, в том числе с дедлайном и просроченных.',
          'Авторы, Исполн. — количество уникальных авторов и исполнителей.',
          'Время в задачах БП, Время по проектам, Задачи в проектах — время, проведённое в задачах бизнес-процесса и в проектах этого этапа.',
          'Почта (раундов), Ожидание почты — переписка и время ожидания ответов.',
          'Где время — краткая разбивка: этап, задачи БП, проекты, задачи в проектах, почта.',
          'Узкое место — отметка «Да» у этапа с наибольшим суммарным временем (этап + задачи + проекты + почта).',
        ],
        tips: [
          'При ускорении этапа с меткой «Узкое место» следующим узким местом станет этап со следующим по величине временем.',
        ],
      },
      {
        id: 'bp-bottlenecks',
